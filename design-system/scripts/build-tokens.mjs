...
const figmaExportPath = path.resolve("design-tokens.tokens.json")
const tokensRawPath = path.resolve("design-system/source/figma/tokens.raw.json")
const themesRawPath = path.resolve("design-system/source/figma/themes.raw.json")

const tokensDistDir = path.resolve("design-system/packages/tokens/dist")
const themesSrcDir = path.resolve("design-system/packages/themes/src")
const themesDistDir = path.resolve("design-system/packages/themes/dist")
