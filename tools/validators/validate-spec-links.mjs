...
const errors = []
const specPaths = walkFiles(path.resolve("requirements/domains"), (filePath) => filePath.endsWith("/spec.md"))
const linkPaths = walkFiles(path.resolve("requirements/domains"), (filePath) => filePath.endsWith("/links.json"))
