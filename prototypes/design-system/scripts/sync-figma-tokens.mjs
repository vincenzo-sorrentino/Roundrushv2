...
const destinationDir = path.resolve("prototypes/design-system/source/figma")
const requiredFiles = ["tokens.raw.json", "themes.raw.json", "components.raw.json"]

if (!sourceDir) {
  console.log("Usage: node prototypes/design-system/scripts/sync-figma-tokens.mjs <figma-export-directory>")
  process.exit(1)
}
